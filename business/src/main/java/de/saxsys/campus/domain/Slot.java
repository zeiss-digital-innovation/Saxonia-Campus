...
@NamedQueries({
        ...
        @NamedQuery(name = "Slot.findByTitle",
                query = "SELECT s FROM Slot s WHERE s.title = :title"),
        @NamedQuery(name = "Slot.findByDescription",
                query = "SELECT s FROM Slot s WHERE s.description = :description"),
        @NamedQuery(name = "Slot.findByStarttime",
                query = "SELECT s FROM Slot s WHERE s.starttime = :starttime"),
        @NamedQuery(name = "Slot.findByEndtime",
                query = "SELECT s FROM Slot s WHERE s.endtime = :endtime") })
public class Slot implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "reservation", joinColumns = {@JoinColumn(name = "SLOT_ID",
